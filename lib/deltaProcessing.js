    ...
    if (
      ...
      for (const organisationUUID of organisationUUIDs) {
        ...
        if (allowedOrganisationUUIDs.includes(organisationUUID)) {
          ...
          //TODO: instead of ignoring the data and resulting in this error
          //message, we should place the data in a discard graph so that it can
          //still be used to find paths, but will not be published in the
          //organisation. This data will be ignored in next iterations of this
          //service.
          results.push({
            success: false,
            mode: 'Insert',
